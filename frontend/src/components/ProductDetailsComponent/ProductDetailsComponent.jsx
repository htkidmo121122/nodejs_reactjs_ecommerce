        ...
        <Loading isLoading={isLoading}>
            <Row style={{ padding: '16px', background: '#fff', borderRadius: '4px', height:'auto' }}>
                ...
                <Col span={14} style={{ paddingLeft: '10px' }}>
                    ...
                    <WrapperPriceProduct>
                        <WrapperPriceTextProduct><ProductPrice originalPrice={productDetails?.price} discount={productDetails?.discount} /> <div style={{ color: 'red', fontSize: '25px'}}> -{productDetails?.discount}% </div>
                        
                        </WrapperPriceTextProduct>
                        <div style={{ color: 'grey', marginTop: '-15px', fontSize: '20px', paddingLeft: '10px', paddingBottom: '5px'}}>
                            Giá gốc: {convertPrice(productDetails?.price)}
                        </div>
