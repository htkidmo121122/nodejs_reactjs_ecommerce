...
const DetailsOrderPage = () => {
  ...
  return (
   <Loading isLoading={isLoading}>
     <div style={{width: '100%', height: '100vh', background: '#f5f5fa', paddingBottom: '10px'}}>
      <div style={{ width: '1270px', margin: '0 auto', height: '1270px'}}>
        <h4 style={{textAlign: 'center' ,fontSize: '25px', paddingTop: '10px'}}>Chi Tiết Đơn Hàng</h4>
        <WrapperHeaderUser>
          <WrapperInfoUser>
          ...
          <WrapperInfoUser>
            ...
            <WrapperContentInfo>
              <div className='delivery-info'><span className='name-delivery'> </span>Giao hàng tiết kiệm</div>
              ...
              <WrapperProduct>
                <WrapperNameProduct>
                  ...
                  <div style={{
                    ...
                    marginLeft: '10px',
                    height: '70px',
                  }}>{renderName(order?.orderItems)}</div>
                </WrapperNameProduct>
